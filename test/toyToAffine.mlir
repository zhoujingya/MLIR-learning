...
// CHECK-NEXT:      %alloc_5 = memref.alloc() : memref<2x3xf64>
// CHECK-NEXT:      affine.store %cst_4, %alloc_5[0, 0] : memref<2x3xf64>
// CHECK-NEXT:      affine.store %cst_3, %alloc_5[0, 1] : memref<2x3xf64>
// CHECK-NEXT:      affine.store %cst_2, %alloc_5[0, 2] : memref<2x3xf64>
// CHECK-NEXT:      affine.store %cst_1, %alloc_5[1, 0] : memref<2x3xf64>
// CHECK-NEXT:      affine.store %cst_0, %alloc_5[1, 1] : memref<2x3xf64>
// CHECK-NEXT:      affine.store %cst, %alloc_5[1, 2] : memref<2x3xf64>
// CHECK-NEXT:      affine.for %arg0 = 0 to 2 {
// CHECK-NEXT:        affine.for %arg1 = 0 to 3 {
// CHECK-NEXT:          %0 = affine.load %alloc_5[%arg0, %arg1] : memref<2x3xf64>
// CHECK-NEXT:          %1 = arith.mulf %0, %0 : f64
// CHECK-NEXT:          affine.store %1, %alloc[%arg0, %arg1] : memref<2x3xf64>
// CHECK-NEXT:        }
// CHECK-NEXT:      }
// CHECK-NEXT:      toy.print %alloc : memref<2x3xf64>
// CHECK-NEXT:      memref.dealloc %alloc_5 : memref<2x3xf64>
